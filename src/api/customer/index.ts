...
export const remoteList = (params: IQueryList) => {
    return http.get<IResponse>(`/api/shop/customer`, {params})
}
/**
 * 添加信息
 * @param data 
...
export const addInfo = (data: IQueryList) => {
    return http.post<IResponse>(`/api/shop/customer`, data)
}
...
export const updateInfo = (data: IQueryList) => {
    return http.put<IResponse>(`/api/shop/customer`, data)
}
...
export const deleteInfo = (params: IQueryList) => {
    return http.delete<IResponse>(`/api/shop/customer`, {params})
}